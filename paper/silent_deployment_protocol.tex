...
\author{
  ...
  \\
  Proposed Partner Site: \textcolor{red}{[PLACEHOLDER ---}\\
  \textcolor{red}{partner academic medical center adult ICU,}\\
  \textcolor{red}{to be named after partner confirmation]}
}
...
\textbf{ClinicalTrials.gov Identifier:} \textcolor{red}{[PLACEHOLDER --- NCT\#, assigned upon registration prior to first patient enrollment]}
...
\begin{itemize}
  \item Baseline TTR (actual care, heparin): 55\%, drawn from the antithrombotic-stewardship systematic review of \citet{wan2008}. \citet{nemati2016} is frequently cited in the RL-for-anticoagulation literature but does not itself report a TTR number --- its primary outcome is accumulated reward under a sigmoid-shaped aPTT function --- and is not the source of the 55\% figure.
...
\emph{Circulation: Cardiovascular Quality and Outcomes.} 2008;1(2):84--91. doi:10.1161/CIRCOUTCOMES.108.796185.
