...
\author{
  ...
  \\
  Proposed Partner Site: \textcolor{red}{[PLACEHOLDER --- UCSD Health Sulpizio Cardiovascular Center / Jacobs Medical Center ICU]}
}
...
\textbf{Protocol Identifier:} \textcolor{red}{[PLACEHOLDER --- UCSD HRPP PROTOCOL \#]}\\
...
Sponsor & \textcolor{red}{[PLACEHOLDER --- e.g., UCSD Office of Research Affairs]} \\
IRB of Record & University of California San Diego Human Research Protections Program (HRPP) \\
...
This protocol will be submitted to the University of California San Diego Human Research Protections Program (UCSD HRPP) for review and approval prior to any study-related activity. Protocol identifier: \textcolor{red}{[PLACEHOLDER --- HRP-XXXX]}. The study will not commence until a favorable opinion has been received.
