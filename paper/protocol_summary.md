...
The primary test is one-sided non-inferiority of counterfactual-policy TTR relative to actual-care TTR with a 10-percentage-point margin, α=0.025, power 0.80. With a baseline TTR of 55% (Nemati 2016) and SD of 22 percentage points, the conservative independent-sample formula yields ~77 patients per arm; accounting for attrition and interim alpha spending, enrollment is planned at 350 with authority to extend to 500.
